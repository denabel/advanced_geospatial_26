...
What data we require: We need the two population raster layers for Texas in 2000 and 2020 (`./data/worldpop/US-TX_ppp_2000_1km.tif` and `./data/worldpop/US-TX_ppp_2020_1km.tif`). We also need county shapefiles for Texas, which can be downloaded with the `tigris` package (`tigris::counties("TX")`). 
...
TX_pop_2020 <- terra::rast("./data/worldpop/US-TX_ppp_2020_1km.tif")
TX_pop_2000 <- terra::rast("./data/worldpop/US-TX_ppp_2000_1km.tif")
