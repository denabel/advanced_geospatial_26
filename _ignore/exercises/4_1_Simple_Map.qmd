...
We are now focusing on creating a first map based on raster data in `ggplot`. We will work with population data in the US.

::: callout-note
## 🏋️ Exercise 1

Load the WorldPop file for the USA in 2020 (`./data/worldpop/usa_ppp_2020_1km_Aggregated.tif`). Create a simple plot with `terra::plot()` to inspect the data.
:::
...
- Then crop the raster file based on the bbox.
:::
...
# Load the data
USA_pop_2020 <- terra::rast("./data/worldpop/usa_ppp_2020_1km_Aggregated.tif")
