...
In the previous session, we have created a raster stack and a raster cube for the four years in Texas. If these are not in your environment anymore, please load both (`./data/stacks/TX_pop_stack.tif` and `./data/stacks/TX_pop_cube.rds`). 
...
TX_pop_stack <- terra::rast("./data/stacks/TX_pop_stack.tif")

# Load the raster cube
TX_pop_cube <- readRDS("./data/stacks/TX_pop_cube.rds")
