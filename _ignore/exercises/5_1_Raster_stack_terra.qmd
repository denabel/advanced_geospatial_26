...
Load the four population raster layers for Texas 2017-2020 (`./data/worldpop/US-TX_ppp_2017_1km.tif`-`./data/worldpop/US-TX_ppp_2020_1km.tif`) with `terra::rast()` and integrate these into one raster stack. Either do this in two steps or by creating a file list and directly read these GeoTiffs as a stack.
:::
