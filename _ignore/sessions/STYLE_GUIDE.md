...
Two custom CSS files extend the theme:
  ...
  tweaks.css       — Spacing (h2, p), custom classes
                     (.smaller-text, .smaller-output)
...
--- Entire block after click (including text) ---
  ...
  Click 1 → text + code appear.
  Click 2 → output appears.
...
========================================================================
  ...
  #| include: false                       Hide both (for setup chunks)
  #| output-location: fragment            Output after click (below)
  #| output-location: column-fragment     Output after click (right col)
  #| class-output: smaller-output         Shrink output (see section 4)
  #| fig.asp: .8                          Plot aspect ratio
  #| out-width: "80%"                     Plot width on the slide
  #| code-line-numbers: "3"               Highlight line 3
  #| layout-ncol: 2                       Multiple plots side by side
