...
german_districts <- sf::read_sf("./data/boundaries/VG250_KRS.shp")

# load district attributes
attributes_districts <- 
  readr::read_csv2("./data/misc/attributes_districts.csv") |> 
...
german_states <- sf::read_sf("./data/boundaries/VG250_LAN.shp")
```
...
ger_pop_2020 <- terra::rast("./data/worldpop/deu_ppp_2020_1km_Aggregated.tif")
...
## Exercise 4_1: A simple map {.center style="text-align: center;"}

[🖱 Click here to open the exercise](https://denabel.github.io/advanced_geospatial_26/exercises/4_1_Simple_Map.html)
...
```{r}
ger_pop_2000 <- terra::rast("./data/worldpop/deu_ppp_2000_1km_Aggregated.tif") |> 
...
#| eval: false
#| fig.asp: 0.8
NRW_districts <- sf::read_sf("./data/boundaries/VG250_KRS.shp") |> 
  filter(SN_L == "05")
...
## Exercise 4_2: A fancy map {.center style="text-align: center;"}

[🖱 Click here to open the exercise](https://denabel.github.io/advanced_geospatial_26/exercises/4_2_Fancy_Map.html)
