...
The ERA5 files are pre-downloaded in `./data/EO_data/C3S_data/`. The following slides show how we obtained them so you understand the workflow — **you don't need to run this code yourself**.
:::
...
- This is the **ecological fallacy** made visible: even if there were a country-level pattern, it would not reflect individual-level reality
